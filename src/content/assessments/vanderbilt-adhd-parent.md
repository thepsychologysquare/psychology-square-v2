...
scoringSummary: "Items 1–47 are rated 0 (never) to 3 (very often); a score of 2 or 3 on a symptom item is considered positive. Items 48–55 assess performance and are rated separately. This scale should not be used alone to make a diagnosis — it should be considered alongside information from multiple sources."
