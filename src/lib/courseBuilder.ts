...
// Lesson content rendering now lives in src/lib/richText.ts, shared with
// workshop details -- re-exported here so existing imports of textToHtml
// from this file keep working unchanged.
export { textToHtml } from './richText';
