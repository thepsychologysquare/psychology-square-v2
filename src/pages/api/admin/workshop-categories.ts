...
import { listWorkshopCategories, addWorkshopCategory } from '../../../lib/workshopCategories';
...
export const POST: APIRoute = async ({ request }) => {
  ...
  try {
    const category = await addWorkshopCategory(env, label);
